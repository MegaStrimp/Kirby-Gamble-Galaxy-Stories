...
function scr_Localization(argument0,argument1,argument2,argument3)
{
	...
	*/
	...
	dialogue[0][2][i][10] = "";
	i += 1;
	dialogue[0][2][i][0] = "Poppy Bros Jr.";
	dialogue[0][2][i][1] = "";
	dialogue[0][2][i][2] = "";
	dialogue[0][2][i][3] = "";
	dialogue[0][2][i][4] = "";
	...
	#region Enemies
	var i = 0;
	dialogue[4][1][i][0] = "The most common of Popstar residents. Many have chosen to work for King Dedede, some even choosing to wield spears or parasols.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "These creatures are known to shoot a beam out of their singular large eye.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A flying foe who takes to the skies whenever someone gets near, and will try and ram into you sometimes.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A baby Tookey, never seen far from its mother. They are known to ram into others for fun.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "The adult variant of Twizzy that is always found near its chicks. It will ram into anyone who gets near its babies.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A knight of the bladed boomerang variety. By channeling his energy he can throw a larger blade.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "An invincible ball of spikes, yowch! Can break ability stars upon contact.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A very angry variant of the classic Gordo. This version's horns pierce the air, and it's metal shines like a red sun.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "These cannons are a staple of the Halberd and Castle Dedede's arsenals. Can come in single shot and 3 round burst flavors.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A Waddle Doo warped by the power of Flux. By utilizing its new power it can create a beam barrier, which can also be launched forward.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Such a pleasant little friend! Bouncies bounce up and down. A simple life, but a happy one. That little face looks familiar...";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "It's a sentient booger that seems to walk aimlessly, but in reality it’s looking for some tissues.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A small bomb with a face. If you get too close, it'll detonate, so steer clear.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A mining bot, built for the sole purpose of harvesting Alexandrum, a mysterious mineral.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "These ghosts look oddly like Waddle Dees. It's probably a coincidence. They pop out of pots like funny genies, and fly up, up, and away!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "An old candle brought to life by flux. Has a distinct dislike for sodas, as it causes it to have severe hiccups.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "One of the native residents of Popstar, these shy creatures will shoot their mushroom caps into the air when approached, and will panic if their cap is stolen.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "These little guys have one goal; clean everything they can. This results in a bit of a bad habit, being ramming into people by accident. Despite their witchy appearances, they mean well.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "These palm tree fruits are packed with explosives to spread the seeds inside, but only fall when you run under, so watch out!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "An enemy who prefers sleeping over fighting, most commonly found near the Fountain of Dreams.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Shing! This angry fellow rolls across the ground, quick as a racecar, trying to slice up it's foes. This creature was devised by the mind of a mysterious painter, and looks a bit like a Gordo.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "This deceiving enemy looks cute at first glance, but anger it and it will become rabid and explode after a few seconds. cannot be swallowed.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A sentient boulder that tries to crush threats with its body. grants the stone ability upon swallowing.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A large bear that lives in dense forests. it can use its claws to grab onto foes and scratch them, usually when provoked.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A small pineapple sapling. Jungle Bombs will puke up bombs at threats, up to 3.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "An aquatic plant who will periodically shoot water out of its mouth, up to 5 projectiles at a time.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "These ancient statues spin across the land, ramming into whoever is unfortunate enough to be in their path.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A hotheaded creature capable of many fire based attacks, such as shooting a flame ball.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A creature that looks a lot like a juicy red vegetable. Or is it a fruit? It will forever be a mystery.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Onion, contrary to its name, is a missile like carrot creature native to egg gardens. They like to hide in the soil and ambush people passing by.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "An aquatic creature with long tendrils jutting from its head. It dances back and forth to the waves of the oceans they reside in.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Gim is a fanatic of all things yoyos, and is a master of wielding them. rumor has it their collection has over 50 different yoyos!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A trouble making kid with an innate love for explosives. Nobody knows where they get all of those bombs from.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A creature that appears to be a walking fireball. Hotter than a Hothead, but doesn't seem to think very much. ";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Don't underestimate this guy by his cute appearance. This creature can fly and explode at will. It will drop out of the sky like an airstrike to explode, so look out!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "That's no door! If you try to go through these fake doors, they'll jump up and try to squish you!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Native to Grass Land, these arachnids dangle from trees, hoping someone will bump into them. This rarely happens. It's said there is a variant of this species that can walk on two legs...";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A stack of cute rocks. Very jumpy fellows. Boing!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "Highly dangerous enemy. It will leap from ledges and release a big explosion, which will hurt you pretty badly.";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
	...
	dialogue[4][1][i][10] = "";
	i += 1;
	dialogue[4][1][i][0] = "A powerful magician, with strong mirror-oriented magic. He can create clones of himself, warp around, and more!";
	dialogue[4][1][i][1] = "";
	dialogue[4][1][i][2] = "";
	dialogue[4][1][i][3] = "";
	dialogue[4][1][i][4] = "";
