...
function scr_DebugSave()
{
	...
	global.bestiaryEnemiesGimUnlocked = true;
	global.bestiaryEnemiesHotheadUnlocked = true;
	global.bestiaryEnemiesSparkyUnlocked = true;
	global.bestiaryEnemiesYolkyUnlocked = true;
	global.bestiaryEnemiesWheelieUnlocked = true;
	global.bestiaryEnemiesPacloudUnlocked = true;
	global.bestiaryEnemiesLaserBallUnlocked = true;
	global.bestiaryEnemiesJackleUnlocked = true;
	global.bestiaryEnemiesKooklerUnlocked = true;
	global.bestiaryEnemiesUfoUnlocked = true;
	global.bestiaryEnemiesBouncySisUnlocked = true;
	global.bestiaryEnemiesFlamerUnlocked = true;
	global.bestiaryEnemiesChuckieUnlocked = true;
	global.bestiaryEnemiesWalkyUnlocked = true;
	global.bestiaryEnemiesMysticBlockUnlocked = true;
	global.bestiaryEnemiesLovelyUnlocked = true;
	global.bestiaryEnemiesPlasmaWispUnlocked = true;
	global.bestiaryEnemiesCapsuleJ2Unlocked = true;
	global.bestiaryEnemiesCeruleanUnlocked = true;
	global.bestiaryEnemiesWizzerUnlocked = true;
	global.bestiaryEnemiesMopooUnlocked = true;
	global.bestiaryEnemiesGolemUnlocked = true;
