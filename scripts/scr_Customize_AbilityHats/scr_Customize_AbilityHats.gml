...
function scr_Customize_AbilityHats()
{
	...
	abilityHatPaintTitleDraw[i][k][h] = "Slicing Gold";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Blood Blade";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Bitcrushed";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Sparkling Beam";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Flux Nostalgia";
	...
	abilityHatSkinValue[i][k] = "marxSoul";
	abilityHatSkinUnlocked[i][k] = true;
	abilityHatSkinOffset[i][k] = 0;
	abilityHatSkinOffsetLerp[i][k] = 0;
	var h = 0;
	abilityHatPaintTitle[i][k][h] = "Jester Spirit";
	abilityHatPaintTitleDraw[i][k][h] = "Jester Spirit";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Summer Fruits";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Rocky Road";
	...
	abilityHatSkinValue[i][k] = "modern";
	abilityHatSkinUnlocked[i][k] = true;
	abilityHatSkinOffset[i][k] = 0;
	abilityHatSkinOffsetLerp[i][k] = 0;
	var h = 0;
	...
	abilityHatPaintTitleDraw[i][k][h] = "Molten Rock";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Jester Reflection";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Beta Block";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Stealthy Maroon";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Sliver-Lined Warrior";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Explosive B";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Scorching Scarlet";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Blazing Blue";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Scarlet Rose";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Frosted Shard";
	...
	abilityHatSkinTitleDraw[i][k] = "Snowman";
	abilityHatSkinValue[i][k] = "snowman";
	abilityHatSkinUnlocked[i][k] = true;
	abilityHatSkinOffset[i][k] = 0;
	abilityHatSkinOffsetLerp[i][k] = 0;
	var h = 0;
	abilityHatPaintTitle[i][k][h] = "Chilly";
	abilityHatPaintTitleDraw[i][k][h] = "Chilly";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Electro Marine";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Spinning Violet";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Rushing Red";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Dapper Painter";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Crimson Champion";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Blue Banner";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Rainbow Flight";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Speed Machine";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Speedy Scarlet";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Slicing Green";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Thundering Cloud";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Lazy Red";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Crushing Brown";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Construction Work";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Dazzling Default";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Presto Purple";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Tempo Teal";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Ringing Rose";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Candescent Copper";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Shining Silver";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Polished Plant";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Illuminated Ivory";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Bubbly Green";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Noddy Peach";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Royal Purple";
	...
	abilityHatPaintTitleDraw[i][k][h] = "Metallic Red";
