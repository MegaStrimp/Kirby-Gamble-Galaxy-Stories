...
/// @param  pinch_end
/// @param  trail_depth
function scr_create_trail_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) {
