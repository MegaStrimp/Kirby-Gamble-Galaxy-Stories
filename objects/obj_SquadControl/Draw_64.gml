...
draw_sprite_part(spr_Healthbar_Boss_InnerFront,0,0,0,sprite_get_width(spr_Healthbar_Boss_InnerFront) * ((waveProgressBarMax[currentWave] - waveProgressBar[currentWave]) / waveProgressBarMax[currentWave]),sprite_get_height(spr_Healthbar_Boss_InnerFront),316,27);
