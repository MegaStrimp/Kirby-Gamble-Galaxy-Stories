...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Jackle);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Jackle_Normal_Idle;
		spawnedEnemy.sprReady = spr_Jackle_Normal_Ready;
		spawnedEnemy.sprAttack = spr_Jackle_Normal_Attack;
		spawnedEnemy.sprReload = spr_Jackle_Normal_Reload;
		spawnedEnemy.sprHurt = spr_Jackle_Normal_Hurt;
		break;
	}
