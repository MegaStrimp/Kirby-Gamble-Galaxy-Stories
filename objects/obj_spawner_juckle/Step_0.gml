...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Juckle);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Juckle_Normal_Idle;
		spawnedEnemy.sprReady = spr_Juckle_Normal_Ready;
		spawnedEnemy.sprAttack = spr_Juckle_Normal_Attack;
		spawnedEnemy.sprReload = spr_Juckle_Normal_Reload;
		spawnedEnemy.sprHurt = spr_Juckle_Normal_Hurt;
		break;
	}
