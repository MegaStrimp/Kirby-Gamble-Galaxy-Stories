...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Glunk);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Glunk_Normal_Idle;
		spawnedEnemy.sprHurt = spr_Glunk_Normal_Hurt;
		break;
	}
	...
	spawnedEnemy.animDirTimerMax = animDirTimerMax;
	spawnedEnemy.animDirTimer = animDirTimer;
	spawnedEnemy.animDirTimerMin = animDirTimerMin;
