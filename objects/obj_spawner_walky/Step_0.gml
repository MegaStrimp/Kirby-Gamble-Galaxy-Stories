...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Walky);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Walky_Normal_Idle;
		spawnedEnemy.sprWalk = spr_Walky_Normal_Walk;
		spawnedEnemy.sprAttack = spr_Walky_Normal_Attack;
		spawnedEnemy.sprHurt = spr_Walky_Normal_Hurt;
		break;
	}
