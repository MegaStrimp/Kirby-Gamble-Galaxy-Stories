...
if (instance_exists(obj_Maykr_ControlO))
{
...
if (setButtons)
{
	...
	{
		case "collision":
		var button = instance_create_depth(360 + (29 * 0),35 + (29 * 0),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_collision_wall";
		button.layerIndex = "collision";
		var button = instance_create_depth(360 + (29 * 1),35 + (29 * 0),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_collision_slope";
		button.layerIndex = "collision";
		var button = instance_create_depth(360 + (29 * 2),35 + (29 * 0),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_collision_gentleSlope";
		button.layerIndex = "collision";
		var button = instance_create_depth(360 + (29 * 3),35 + (29 * 0),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_collision_superGentleSlope";
		button.layerIndex = "collision";
		var button = instance_create_depth(360 + (29 * 0),35 + (29 * 1),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_collision_ladder";
		button.layerIndex = "collision";
		var button = instance_create_depth(360 + (29 * 1),35 + (29 * 1),depth - 1,obj_Maykr_ButtonO);
		...
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 2),35 + (29 * 1),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_breakingWall";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 3),35 + (29 * 1),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_crate";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 0),35 + (29 * 2),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_durableBlock";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 1),35 + (29 * 2),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_bumper";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 2),35 + (29 * 2),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_spring";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 3),35 + (29 * 2),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_trampoline";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 0),35 + (29 * 3),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_food";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 1),35 + (29 * 3),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_pepBrew";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 2),35 + (29 * 3),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_maximTomato";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 3),35 + (29 * 3),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_1Up";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 0),35 + (29 * 4),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_spike";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 1),35 + (29 * 4),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_pointStar";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 2),35 + (29 * 4),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_popFlower";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 3),35 + (29 * 4),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_itemChest";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 0),35 + (29 * 5),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_button";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 1),35 + (29 * 5),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_gate";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 2),35 + (29 * 5),depth - 1,obj_Maykr_ButtonO);
		button.state = "item_environment_abilityTrophy";
		button.layerIndex = "environment";
		var button = instance_create_depth(360 + (29 * 3),35 + (29 * 5),depth - 1,obj_Maykr_ButtonO);
