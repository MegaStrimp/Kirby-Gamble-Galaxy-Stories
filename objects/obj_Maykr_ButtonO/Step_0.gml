...
switch (state)
{
	...
	if (obj_Maykr_ControlO.optionIndex.spawnedDirX == 1)
	{
		image_index = 0;
	}
	else
	...
	if (obj_Maykr_ControlO.optionIndex.spawnedPaletteIndex == paletteIndex)
	{
		image_index = 1;
	}
	else
	...
	if (obj_Maykr_ControlO.optionIndex.spawnedAbilityIndex == abilityIndex)
	{
		image_index = 1;
	}
	else
...
if ((instance_exists(obj_Maykr_ControlO)) and (instance_exists(obj_Maykr_HudO)))
{
	if (global.gambleMaykr)
	{
		if (obj_Maykr_ControlO.active)
		{
			visible = false;
		}
		else
		{
			visible = true;
			if ((((!obj_Maykr_ControlO.optionsOpen) and (!optionsButton)) or ((obj_Maykr_ControlO.optionsOpen) and (optionsButton))) and (position_meeting(mouse_x,mouse_y,id)) and (mouse_check_button_pressed(mb_left)))
			{
				switch (state)
				{
					//Main
					...
					case "settings":
					//obj_Maykr_ControlO.optionIndex = "stage";
					//obj_Maykr_ControlO.setupOptions = true;
					break;
					...
					obj_Maykr_ControlO.spawnedItemIndex = obj_StarBlock;
					obj_Maykr_ControlO.spawnedSprite = spr_StarBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					obj_Maykr_ControlO.draggedObject = false;
					with (obj_Maykr_SpawnerO)
					{
					...
					obj_Maykr_HudO.setButtons = true;
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_WaddleDee;
					obj_Maykr_ControlO.spawnedSprite = spr_WaddleDee_Normal_Idle;
					...
					case "play":
					global.pause = false;
					obj_Maykr_ControlO.active = true;
					with (obj_Maykr_SpawnerO) active = true;
					...
					if (file != "")
					{
						...
						{
							with (obj_Maykr_SpawnerO) instance_destroy();
						...
						{
							obj_Maykr_ControlO.errorMsg = "Invalid Maykr File";
							obj_Maykr_ControlO.errorAlpha = 1;
							obj_Maykr_ControlO.errorAlphaTimer = obj_Maykr_ControlO.errorAlphaTimerMax;
						}
					}
					else
					{
						obj_Maykr_ControlO.errorMsg = "Open A Maykr File";
						obj_Maykr_ControlO.errorAlpha = 1;
						obj_Maykr_ControlO.errorAlphaTimer = obj_Maykr_ControlO.errorAlphaTimerMax;
					}
					break;
					...
					{
						with (obj_Maykr_SpawnerO) if (spawnedItemIndex != obj_Player) instance_destroy();
						trashCountdown = -1;
					}
					break;
					...
					case "optionsExit":
					obj_Maykr_ControlO.optionsOpen = false;
					obj_Maykr_ControlO.optionIndex = -1;
					with (obj_Maykr_ButtonO)
					{
					...
					case "optionsStatePlus":
					if (obj_Maykr_ControlO.optionIndex.spawnedState < obj_Maykr_ControlO.optionIndex.spawnedStateMax) obj_Maykr_ControlO.optionIndex.spawnedState += 1;
					break;
					
					case "optionsStateMinus":
					if (obj_Maykr_ControlO.optionIndex.spawnedState > 0) obj_Maykr_ControlO.optionIndex.spawnedState -= 1;
					break;
					
					case "optionsWidthPlus":
					if (obj_Maykr_ControlO.width > 0) obj_Maykr_ControlO.width += 1;
					room_set_width(room,obj_Maykr_ControlO.width * 24);
					break;
					
					case "optionsWidthMinus":
					if (obj_Maykr_ControlO.width > 20) obj_Maykr_ControlO.width -= 1;
					room_set_width(room,obj_Maykr_ControlO.width * 24);
					break;
					
					case "optionsHeightPlus":
					if (obj_Maykr_ControlO.height > 0) obj_Maykr_ControlO.height += 1;
					room_set_height(rm_Maykr,obj_Maykr_ControlO.height * 24);
					break;
					
					case "optionsHeightMinus":
					if (obj_Maykr_ControlO.height > 12) obj_Maykr_ControlO.height -= 1;
					room_set_height(room,obj_Maykr_ControlO.height * 24);
					break;
					
					case "optionsMirror":
					if (obj_Maykr_ControlO.optionIndex.spawnedDirX == 1)
					{
						obj_Maykr_ControlO.optionIndex.spawnedDirX = -1;
					}
					else
					{
						obj_Maykr_ControlO.optionIndex.spawnedDirX = 1;
					...
					case "optionsPalette":
					obj_Maykr_ControlO.optionIndex.spawnedPaletteIndex = paletteIndex;
					break;
					
					case "optionsAbility":
					obj_Maykr_ControlO.optionIndex.spawnedAbilityIndex = abilityIndex;
					break;
					...
					case "item_collision_ladder":
					obj_Maykr_ControlO.spawnedLayer = "collision";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Ladder;
					obj_Maykr_ControlO.spawnedSprite = spr_Maykr_Debug_Ladder;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_collision_platform":
					obj_Maykr_ControlO.spawnedLayer = "collision";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Platform;
					obj_Maykr_ControlO.spawnedSprite = spr_Maykr_Debug_Platform;
					obj_Maykr_ControlO.snap = 24;
					break;
					...
					case "item_environment_bigStarBlock":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BigStarBlock;
					obj_Maykr_ControlO.spawnedSprite = spr_BigStarBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_bombBlock":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BombBlock;
					obj_Maykr_ControlO.spawnedSprite = spr_BombBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_bombSolidBlock":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BombSolidBlock;
					obj_Maykr_ControlO.spawnedSprite = spr_BombSolidBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_bombSolidBlockInvis":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BombSolidBlock_Invis;
					obj_Maykr_ControlO.spawnedSprite = spr_BombSolidBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					...
					case "item_environment_abilityBlock":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_AbilityBlock;
					obj_Maykr_ControlO.spawnedSprite = spr_AbilityBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_breakingWall":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BreakingWall;
					obj_Maykr_ControlO.spawnedSprite = spr_BreakingWall_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_crate":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Crate;
					obj_Maykr_ControlO.spawnedSprite = spr_Crate_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_durableBlock":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_DurableBlock;
					obj_Maykr_ControlO.spawnedSprite = spr_DurableBlock_Normal_Idle;
					obj_Maykr_ControlO.snap = 24;
					break;
					
					case "item_environment_bumper":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Bumper;
					obj_Maykr_ControlO.spawnedSprite = spr_Bumper_Normal;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_spring":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Spring;
					obj_Maykr_ControlO.spawnedSprite = spr_Spring_Normal;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_trampoline":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Trampoline;
					obj_Maykr_ControlO.spawnedSprite = spr_Trampoline_Normal;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_food":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Food;
					obj_Maykr_ControlO.spawnedSprite = spr_Food;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_pepBrew":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_PepBrew;
					obj_Maykr_ControlO.spawnedSprite = spr_PepBrew;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_maximTomato":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_MaximTomato;
					obj_Maykr_ControlO.spawnedSprite = spr_MaximTomato;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_1Up":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_1Up;
					obj_Maykr_ControlO.spawnedSprite = spr_1Up;
					obj_Maykr_ControlO.snap = 6;
					break;
					...
					case "item_environment_pointStar":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_PointStar;
					obj_Maykr_ControlO.spawnedSprite = spr_PointStar_Yellow_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_popFlower":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_PopFlower;
					obj_Maykr_ControlO.spawnedSprite = spr_PopFlower_GreenGreens_Closed;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_itemChest":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_ItemChest;
					obj_Maykr_ControlO.spawnedSprite = spr_ItemChest_Normal_Closed;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_button":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Button;
					obj_Maykr_ControlO.spawnedSprite = spr_Button_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_gate":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Gate;
					obj_Maykr_ControlO.spawnedSprite = spr_Gate_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_abilityTrophy":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_AbilityTrophy;
					obj_Maykr_ControlO.spawnedSprite = spr_AbilityTrophy_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_environment_cuttableGrass":
					obj_Maykr_ControlO.spawnedLayer = "environment";
					obj_Maykr_ControlO.spawnedItemIndex = obj_CuttableGrass;
					obj_Maykr_ControlO.spawnedSprite = spr_CuttableGrass_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					...
					case "item_enemies_waddleDoo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_WaddleDoo;
					obj_Maykr_ControlO.spawnedSprite = spr_WaddleDoo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_brontoBurt":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BrontoBurt;
					obj_Maykr_ControlO.spawnedSprite = spr_BrontoBurt_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_twizzy":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Twizzy;
					obj_Maykr_ControlO.spawnedSprite = spr_Twizzy_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_tookey":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Tookey;
					obj_Maykr_ControlO.spawnedSprite = spr_Tookey_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_sirKibble":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_SirKibble;
					obj_Maykr_ControlO.spawnedSprite = spr_SirKibble_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_gordo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Gordo;
					obj_Maykr_ControlO.spawnedSprite = spr_Gordo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_bloodGordo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BloodGordo;
					obj_Maykr_ControlO.spawnedSprite = spr_BloodGordo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_shotzo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Shotzo;
					obj_Maykr_ControlO.spawnedSprite = spr_Shotzo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_mysticDoo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_MysticDoo;
					obj_Maykr_ControlO.spawnedSprite = spr_MysticDoo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_bouncy":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Bouncy;
					obj_Maykr_ControlO.spawnedSprite = spr_Bouncy_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_search":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Search;
					obj_Maykr_ControlO.spawnedSprite = spr_Search_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_wapod":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Wapod;
					obj_Maykr_ControlO.spawnedSprite = spr_Wapod_Normal_Pot;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_cappy":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Cappy;
					obj_Maykr_ControlO.spawnedSprite = spr_Cappy_Normal_IdleL;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_broomHatter":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BroomHatter;
					obj_Maykr_ControlO.spawnedSprite = spr_BroomHatter_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_coconut":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Coconut;
					obj_Maykr_ControlO.spawnedSprite = spr_Coconut_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_noddy":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Noddy;
					obj_Maykr_ControlO.spawnedSprite = spr_Noddy_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_blado":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Blado;
					obj_Maykr_ControlO.spawnedSprite = spr_Blado_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_scarfy":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Scarfy;
					obj_Maykr_ControlO.spawnedSprite = spr_Scarfy_Normal_CalmIdle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_rocky":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Rocky;
					obj_Maykr_ControlO.spawnedSprite = spr_Rocky_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_grizzo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Grizzo;
					obj_Maykr_ControlO.spawnedSprite = spr_Grizzo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_jungleBomb":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_JungleBomb;
					obj_Maykr_ControlO.spawnedSprite = spr_JungleBomb_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_kabu":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_Kabu;
					obj_Maykr_ControlO.spawnedSprite = spr_Kabu_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
					
					case "item_enemies_burningLeo":
					obj_Maykr_ControlO.spawnedLayer = "enemies";
					obj_Maykr_ControlO.spawnedItemIndex = obj_BurningLeo;
					obj_Maykr_ControlO.spawnedSprite = spr_BurningLeo_Normal_Idle;
					obj_Maykr_ControlO.snap = 6;
					break;
				}
			}
