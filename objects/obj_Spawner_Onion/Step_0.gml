...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Onion);
	...
	spawnedEnemy.hasDeathKnockback = hasDeathKnockback;
	...
	spawnedEnemy.hasDeathParticles = hasDeathParticles;
	spawnTimer = -1;
}