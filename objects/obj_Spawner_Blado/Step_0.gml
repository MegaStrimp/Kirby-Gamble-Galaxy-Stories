...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Blado);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Blado_Normal_Idle;
	...
	spawnedEnemy.turnableXTimer = turnableXTimer;
	spawnedEnemy.turnableXTimerMax = turnableXTimerMax;
	spawnedEnemy.turnableYTimer = turnableYTimer;
	spawnedEnemy.turnableYTimerMax = turnableYTimerMax;
	spawnTimer = -1;
}