	...
	else if (!optionsOpen)
	{
		...
		with (obj_Maykr_Spawner)
		{
			...
			if ((mouse_check_button_pressed(mb_left)) and (spawnedLayer == global.gambleMaykrMenu))
			{
				...
				if (place_meeting(x,y,obj_Maykr_Control))
				{
			...
			if ((selected == 1) and (spawnedLayer == global.gambleMaykrMenu))
			{
				...
				if ((mouse_check_button_pressed(mb_left)) and (place_meeting(x,y,obj_Maykr_Control)))
				{
					dragged = 1;
					other.dragX = other.x;
					other.dragY = other.y;
			...
			{
				if ((x != obj_Maykr_Control.x) or (y != obj_Maykr_Control.y))
				{
		...
		{
			optionsOpen = true;
			var button = instance_create_depth(369,24,-900,obj_Maykr_Button);
			button.state = "optionsExit";
			button.optionsButton = true;
			
			if (obj_Maykr_Control.optionIndex != "stage")
			{
				switch (optionIndex.spawnedItemIndex)
				{
					case obj_AbilityTrophy:
					var i = 0;
					button = instance_create_depth(102 + (28 * (i % 10)),99 + (28 * ((i - (i % 10)) / 10)),-900,obj_Maykr_Button);
					...
					button.optionsButton = true;
					i += 1;
					button = instance_create_depth(102 + (28 * (i % 10)) + 1,99 + (28 * ((i - (i % 10)) / 10)),-900,obj_Maykr_Button);
					button.state = "optionsAbility";
					...
					case obj_WaddleDee:
					button = instance_create_depth(126,86,-900,obj_Maykr_Button);
					button.state = "optionsStatePlus";
					button.optionsButton = true;
					button = instance_create_depth(126,92,-900,obj_Maykr_Button);
					button.state = "optionsStateMinus";
					button.optionsButton = true;
					
					button = instance_create_depth(167,86,-900,obj_Maykr_Button);
					button.state = "optionsMirror";
					button.optionsButton = true;
					
					if (global.shaders)
					{
						button = instance_create_depth(234,136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_WaddleWaddle;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 1),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 2),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 3),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 4),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 5),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 6),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 7),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
						...
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 8),136,-900,obj_Maykr_Button);
						button.state = "optionsPalette";
			...
			{
				button = instance_create_depth(132,86,-900,obj_Maykr_Button);
				button.state = "optionsWidthPlus";
				button.optionsButton = true;
				button = instance_create_depth(132,92,-900,obj_Maykr_Button);
				button.state = "optionsWidthMinus";
				button.optionsButton = true;
				button = instance_create_depth(183,86,-900,obj_Maykr_Button);
				button.state = "optionsHeightPlus";
				button.optionsButton = true;
				button = instance_create_depth(183,92,-900,obj_Maykr_Button);
		...
		if ((mouse_check_button(mb_left)) and (!keyboard_check(vk_control)) and (!keyboard_check(vk_shift)) and (!draggedObject) and (!selectedObject) and (!collidingSpawner) and (!place_meeting(x,y,obj_Maykr_Hud)) and (!place_meeting(x,y,obj_Maykr_Button)))
		{
			var spawner = instance_create_layer(x,y,spawnedLayer,obj_Maykr_Spawner);
			spawner.snap = snap;
