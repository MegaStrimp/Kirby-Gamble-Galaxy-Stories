...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Tomatoo);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Tomatoo_Normal_Idle;
		spawnedEnemy.sprDuck = spr_Tomatoo_Normal_Duck;
		spawnedEnemy.sprJump = spr_Tomatoo_Normal_Jump;
		spawnedEnemy.sprFall = spr_Tomatoo_Normal_Fall;
		spawnedEnemy.sprHeavyDuck = spr_Tomatoo_Normal_HeavyDuck;
		spawnedEnemy.sprHurt = spr_Tomatoo_Normal_Hurt;
		break;
	}
	...
	spawnedEnemy.jumpCountMax = jumpCountMax;
	spawnedEnemy.playerOffset = playerOffset;
