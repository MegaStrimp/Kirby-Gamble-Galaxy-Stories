...
if (obj_Maykr_Control.optionsOpen)
{
	draw_set_alpha(.75);
	...
	var title = "Stage";
	if (obj_Maykr_Control.optionIndex != "stage") title = obj_Maykr_Control.optionIndex.spawnedName;
	...
	{
		switch (obj_Maykr_Control.optionIndex.spawnedItemIndex)
		{
			...
			draw_text(camera_get_view_x(gameView) + 114,camera_get_view_y(gameView) + 89,string(obj_Maykr_Control.optionIndex.spawnedState));
			break;
	...
	else
	{
		...
		draw_set_halign(fa_left);
		draw_text(camera_get_view_x(gameView) + 111,camera_get_view_y(gameView) + 89,string(obj_Maykr_Control.width));
		draw_text(camera_get_view_x(gameView) + 162,camera_get_view_y(gameView) + 89,string(obj_Maykr_Control.height));
	}
}