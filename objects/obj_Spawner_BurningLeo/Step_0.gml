...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_BurningLeo);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_BurningLeo_Normal_Idle;
		spawnedEnemy.sprWalk = spr_BurningLeo_Normal_Walk;
		spawnedEnemy.sprDuck = spr_BurningLeo_Normal_Duck;
		spawnedEnemy.sprJump = spr_BurningLeo_Normal_Jump;
		spawnedEnemy.sprFall = spr_BurningLeo_Normal_Fall;
		spawnedEnemy.sprCharge = spr_BurningLeo_Normal_Charge;
		spawnedEnemy.sprAttack = spr_BurningLeo_Normal_Attack;
		spawnedEnemy.sprHurt = spr_BurningLeo_Normal_Hurt;
		break;
	}
