...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_PoppyBrosJr);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_PoppyBrosJr_Normal_Idle;
		spawnedEnemy.sprThrowReady = spr_PoppyBrosJr_Normal_ThrowReady;
		spawnedEnemy.sprThrow = spr_PoppyBrosJr_Normal_Throw;
		spawnedEnemy.sprHand = spr_PoppyBrosJr_Normal_Hand;
		spawnedEnemy.sprHurt = spr_PoppyBrosJr_Normal_Hurt;
		break;
	}
