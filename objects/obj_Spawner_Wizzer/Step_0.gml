...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Wizzer);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Wizzer_Normal_Idle;
		spawnedEnemy.sprOpen = spr_Wizzer_Normal_Open;
		spawnedEnemy.sprClose = spr_Wizzer_Normal_Close;
		spawnedEnemy.sprReady = spr_Wizzer_Normal_Ready;
		spawnedEnemy.sprAttack = spr_Wizzer_Normal_Attack;
		spawnedEnemy.sprHurtNormal = spr_Wizzer_Normal_HurtNormal;
		spawnedEnemy.sprHurtInhale = spr_Wizzer_Normal_HurtInhale;
		break;
	}
	...
	spawnedEnemy.attackTimer = spawnedEnemy.attackTimerMax;
	spawnTimer = -1;
}