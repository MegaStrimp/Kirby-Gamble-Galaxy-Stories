...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_PlasmaWisp);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_PlasmaWisp_Normal_Idle;
		spawnedEnemy.sprCharge = spr_PlasmaWisp_Normal_Charge;
		spawnedEnemy.sprAttack = spr_PlasmaWisp_Normal_Shoot;
		spawnedEnemy.sprAttackBasic = spr_PlasmaWisp_Normal_AttackBasic;
		spawnedEnemy.sprAttackRecharge = spr_PlasmaWisp_Normal_AttackRecharge;
		spawnedEnemy.sprHurt = spr_PlasmaWisp_Normal_Hurt;
		break;
	}
	...
	spawnedEnemy.loopCount = loopCount;
