...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Flamer);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Flamer_Normal_Idle;
		spawnedEnemy.sprReady = spr_Flamer_Normal_Ready;
		spawnedEnemy.sprAttack = spr_Flamer_Normal_Attack;
		spawnedEnemy.sprHurt = spr_Flamer_Normal_Hurt;
		break;
	}
