			...
			if (obj_Maykr_ControlO.optionIndex != "stage")
			{
				switch (optionIndex.spawnedItemIndex)
				{
					...
					if (global.shaders)
					{
						...
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_BlueberryPie;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 1),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_SeenAGhost;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 2),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_Hypothermic;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 2),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_MidnightForest;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 3),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_CelestialGlow;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 3),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_InvertedGold;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 4),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_CherryBomb;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 4),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_Corruption;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 5),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_NightVision;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 5),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_UpsetStomach;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 6),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_FadedWaddle;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 6),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_InvisibleSpray;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 7),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_Snowball;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 7),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_KeyDee;
						button.optionsButton = true;
						button = instance_create_depth(234 + (16 * 8),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_BurntToACrisp;
						button.optionsButton = true;
						button = instance_create_depth(234 - (16 * 8),136,-900,obj_Maykr_ButtonO);
						button.state = "optionsPalette";
						button.paletteIndex = spr_WaddleDee_Normal_Palette_ImpendingDoom;
						button.optionsButton = true;
					}
					break;
