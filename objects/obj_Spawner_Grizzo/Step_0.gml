...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Grizzo);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Grizzo_Normal_Idle;
		spawnedEnemy.sprWalk = spr_Grizzo_Normal_Walk;
		spawnedEnemy.sprDash = spr_Grizzo_Normal_Dash;
		spawnedEnemy.sprSleep = spr_Grizzo_Normal_Sleep;
		spawnedEnemy.sprHurt = spr_Grizzo_Normal_Hurt;
		break;
	}
