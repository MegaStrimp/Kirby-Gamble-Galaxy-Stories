...
if (sprite_index == sprReady)
{
	...
	var projectile = instance_create_depth(x,y,depth - 1,obj_Projectile_JackleBlade);
	...
	projectile.dmg = jackle_Cutter_Damage;
	scr_Attack_SetKnockback(projectile,jackle_Cutter_Strength,jackle_Cutter_HitStopAffectSource,jackle_Cutter_HitStopAffectPlayer,jackle_Cutter_HitStopAffectTarget,jackle_Cutter_HitStopLength,jackle_Cutter_HitStopShakeStrength);
