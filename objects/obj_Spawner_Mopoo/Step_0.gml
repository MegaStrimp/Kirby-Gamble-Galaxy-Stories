...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Mopoo);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprBody = spr_Mopoo_Normal_Body;
		spawnedEnemy.sprFace = spr_Mopoo_Normal_Face;
		spawnedEnemy.sprHurt = spr_Mopoo_Normal_Hurt;
		break;
	}
	spawnedEnemy.sprite_index = spawnedEnemy.sprBody;
	...
	spawnedEnemy.followedPath = followedPath;
	spawnTimer = -1;
}