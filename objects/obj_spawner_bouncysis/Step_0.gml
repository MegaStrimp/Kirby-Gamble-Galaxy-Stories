...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_BouncySis);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_BouncySis_Normal_Idle;
		spawnedEnemy.sprJump = spr_BouncySis_Normal_Jump;
		spawnedEnemy.sprDuck = spr_BouncySis_Normal_Duck;
		spawnedEnemy.sprHurt = spr_BouncySis_Normal_Hurt;
		break;
	}
