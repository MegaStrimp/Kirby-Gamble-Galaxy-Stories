...
switch (character)
{
	...
	draw_sprite_ext(spr_Familiar_HappyPea_Head,index,x,y - 14 + attackYOffset,image_xscale * (1 + scaleExX),image_yscale * (1 + scaleExY),image_angle,image_blend,image_alpha);
	break;
	#endregion
