...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Searches);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Searches_Normal_Idle;
		spawnedEnemy.sprCharge = spr_Searches_Normal_Charge;
		spawnedEnemy.sprHurt = spr_Searches_Normal_Hurt;
		break;
	}
