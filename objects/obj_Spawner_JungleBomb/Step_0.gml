...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_JungleBomb);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_JungleBomb_Normal_Idle;
		spawnedEnemy.sprWalk = spr_JungleBomb_Normal_Walk;
		spawnedEnemy.sprDuck = spr_JungleBomb_Normal_Duck;
		spawnedEnemy.sprJump = spr_JungleBomb_Normal_Jump;
		spawnedEnemy.sprFall = spr_JungleBomb_Normal_Fall;
		spawnedEnemy.sprAttack = spr_JungleBomb_Normal_Attack;
		spawnedEnemy.sprHurt = spr_JungleBomb_Normal_Hurt;
		break;
	}
