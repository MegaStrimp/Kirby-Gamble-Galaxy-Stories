...
switch (state)
{
	...
	draw_set_color(color);
	draw_set_alpha(alpha);
	draw_rectangle(camera_get_view_x(gameView) + (camera_get_view_width(gameView) / 2) + state1Width,camera_get_view_y(gameView) + (camera_get_view_height(gameView) / 2) + state1Height,camera_get_view_x(gameView) + (camera_get_view_width(gameView) / 2) - state1Width,camera_get_view_y(gameView) + (camera_get_view_height(gameView) / 2) - state1Height,0);
	draw_set_alpha(1);
	break;
}