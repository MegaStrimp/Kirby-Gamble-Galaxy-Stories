...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Noddy);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Noddy_Normal_Idle;
		spawnedEnemy.sprWalk = spr_Noddy_Normal_Walk;
		spawnedEnemy.sprSleep = spr_Noddy_Normal_Sleep;
		spawnedEnemy.sprHurt = spr_Noddy_Normal_Hurt;
		break;
	}
	...
	spawnedEnemy.sleepTimer = sleepTimer;
	spawnedEnemy.sleepTimerMax = sleepTimerMax;
	spawnedEnemy.sleepReadyTimerMax = sleepReadyTimerMax;
	spawnedEnemy.sleepReadyTimer = sleepReadyTimer;
	spawnedEnemy.sleepStopTimer = sleepStopTimer;
	spawnedEnemy.sleepStopTimerMax = sleepStopTimerMax;
	spawnTimer = -1;
}