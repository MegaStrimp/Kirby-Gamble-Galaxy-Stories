...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Ufo);
	...
	spawnedEnemy.moveTimerMax = moveTimerMax;
	spawnedEnemy.moveTimerMin = moveTimerMin;
	spawnedEnemy.moveTimer = moveTimer;
	spawnTimer = -1;
}
