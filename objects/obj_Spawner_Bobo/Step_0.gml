...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Bobo);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Bobo_Normal_Idle;
		spawnedEnemy.sprWalk = spr_Bobo_Normal_Walk;
		spawnedEnemy.sprFall = spr_Bobo_Normal_Fall;
		spawnedEnemy.sprHurt = spr_Bobo_Normal_Hurt;
		spawnedEnemy.sprFlame = spr_Bobo_Normal_Flame;
		break;
	}
